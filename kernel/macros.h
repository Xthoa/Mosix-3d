#define ASSERT(expr) ((expr)?(void)0:printk("Assert failed: '%s' in File %s Function %s Line %W\n",#expr,__FILE__,__FUNCTION__,__LINE__))
#define ASSERT_ARG(expr, argfmt, arg...) ((expr)?(void)0:printk("Assert failed: '%s'(" argfmt ") in File %s Function %s Line %W\n",#expr,arg,__FILE__,__FUNCTION__,__LINE__))
